...
| **Likely affected** | `apps/web/**`, docs delivery notes |
| **New files** | App entry, layout, theme, FAQ content, shared copy components, routes |
| **Dependencies** | Decision: UI framework + app location — **approved**: React + Vite in `apps/web` |
| **Risks** | Accidental MilePilot styling bleed; placeholder theatre |
| **Tests** | Typecheck/build; manual mobile + desktop layout checks |
...
| Field | Content |
| --- | --- |
| **Status** | **Seed delivered in Sprint D1** (33 FAQ guides across 6 categories). Later phases may expand depth and topics. |
...
| **Dependencies** | Phase 1 shell (seed shipped with Sprint D1) |
| **Risks** | Over-promising timescales |
| **Complexity** | Low–Medium |

*Sprint D1 shipped the curated seed set; Phase 5 may expand beyond the initial FAQ list.*
