...
**Sprint D3 delivered:** Website Discovery (`/discover`, `/discover/summary`) and initial Workspace shell (`/workspace`). No auth, Ask, Google connections, or SEO scores. `packages/ui` remains scaffold-only.
