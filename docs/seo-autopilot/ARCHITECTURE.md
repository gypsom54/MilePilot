...
**Post–Sprint 5 review:** [PLATFORM_ARCHITECTURE_AUDIT.md](./PLATFORM_ARCHITECTURE_AUDIT.md) — verify boundaries, KG ownership, deps, and shared infrastructure before Sprint 7.
