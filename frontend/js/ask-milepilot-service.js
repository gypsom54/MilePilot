...
(function (global) {
  ...
  var VEHICLE_RATES = { car: 0.55, van: 0.55, bicycle: 0.2, motorcycle: 0.24 };
  ...
  function defaultClaim(mi, vehicle) {
    var rate = VEHICLE_RATES[vehicle] || 0.55;
    return (Number(mi) || 0) * rate;
  }
    ...
    buildReportDeps: function () {
      return {
        ...
        getHmrcRate: function () {
          ...
          return VEHICLE_RATES[getVehicle()] || 0.55;
        },
      };
    },
