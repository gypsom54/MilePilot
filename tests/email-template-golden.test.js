...
assert.ok(html.includes("Download Full PDF Report") || html.includes("Download Report"), "PDF CTA required");
...
assert.ok(html.includes("Today's Mileage Report") || html.includes("Mileage Report"), "title case report title");
assert.ok(html.includes("Daily Report •") || html.includes("📅"), "clean period line");
assert.ok(html.includes("verified business"), "AI insight sentence required");
assert.ok(html.includes("height:108px"), "KPI cards use fixed equal height");
