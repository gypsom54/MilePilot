...
- `apps/` — `apps/web` customer shell (**Sprint D1 DONE/LOCKED**; **Sprint D3 Website Discovery DONE**); `apps/api` composition shell
...
Delivery docs also include [`docs/SPRINT_D1_DELIVERY_REPORT.md`](./docs/SPRINT_D1_DELIVERY_REPORT.md) and [`docs/SPRINT_D3_DELIVERY_REPORT.md`](./docs/SPRINT_D3_DELIVERY_REPORT.md).
