...
- `apps/` — `apps/web` customer shell (**D1–D4 LOCKED**; **Sprint D5 Ask mock UI DONE**); `apps/api` composition shell
...
Delivery docs also include [`docs/SPRINT_D1_DELIVERY_REPORT.md`](./docs/SPRINT_D1_DELIVERY_REPORT.md), [`docs/SPRINT_D3_DELIVERY_REPORT.md`](./docs/SPRINT_D3_DELIVERY_REPORT.md), [`docs/SPRINT_D4_DELIVERY_REPORT.md`](./docs/SPRINT_D4_DELIVERY_REPORT.md) and [`docs/SPRINT_D5_DELIVERY_REPORT.md`](./docs/SPRINT_D5_DELIVERY_REPORT.md).
