...
async function main() {
  ...
  await page.evaluate(() => {
    localStorage.clear();
    if (typeof initTrackingMode === 'function') initTrackingMode(false);
    if (typeof showScreen === 'function') showScreen('trackingMode');
    if (typeof selectTrackingMode === 'function') selectTrackingMode('autopilot');
  });
