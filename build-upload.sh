...
mkdir -p "$ROOT/milepilot-upload-v2/js/business"
cp "$ROOT/frontend/js/"*.js "$ROOT/milepilot-upload-v2/js/" 2>/dev/null || true
cp "$ROOT/frontend/js/business/"*.js "$ROOT/milepilot-upload-v2/js/business/" 2>/dev/null || true
...
node "$ROOT/tests/business-engine.test.js"
