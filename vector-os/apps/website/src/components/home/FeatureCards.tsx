...
const FEATURES = [
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path
          className="feature-card__icon-path"
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <circle className="feature-card__icon-path" cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.5" />
        <path
          className="feature-card__icon-path"
        ...
        <div className="features__grid">
          {FEATURES.map((feature, index) => (
            ...
            >
              ...
              <div className="feature-card__border-glow" aria-hidden="true" />
