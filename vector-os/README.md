...
Tokens are defined in `@vector-os/design-system` and exposed as:

- **TypeScript** — `import { colors, spacing } from '@vector-os/design-system'`
- **CSS** — `import '@vector-os/design-system/tokens.css'` then use `var(--vector-*)` custom properties
