...
let recoveryBuildIdentity = null;
try {
  // Generated by scripts/generate-recovery-provenance.mjs before EAS build
  recoveryBuildIdentity = require('../recovery-build-identity.json');
} catch {
  recoveryBuildIdentity = null;
}
...
const RECOVERY_IDENTITY_INJECT = recoveryBuildIdentity
  ? `window.__MILEPILOT_RECOVERY_IDENTITY__=${JSON.stringify(recoveryBuildIdentity)};`
  : '';
